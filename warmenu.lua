...
local function drawTitle()
	if menus[currentMenu] then
		...
		local y = menus[currentMenu].y + titleHeight / 2
			...
			DrawSprite("menu_textures", "translate_bg_1a", x, y, menus[currentMenu].width, titleHeight, 0.0, 229, 182, 21, 255, 0) 
...
local function drawSubTitle()
	if menus[currentMenu] then
		...
		drawText(menus[currentMenu].subTitle, menus[currentMenu].x + 0.01, y - buttonHeight / 2 + buttonTextYOffset, buttonFont, subTitleColor, buttonScale, false)
